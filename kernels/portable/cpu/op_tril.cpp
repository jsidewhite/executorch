...
void apply_tril(
    CTYPE* __ET_RESTRICT self,
    CTYPE* __ET_RESTRICT out,
    int64_t diagonal,
    int64_t num_rows,
    int64_t num_cols,
    int64_t row_stride,
...
void tril_kernel(
  ...
  for (int64_t i = 0; i < batch_size; i++) {
    CTYPE* __ET_RESTRICT data_self_ptr = &data_self[i * self_stride];
    CTYPE* __ET_RESTRICT data_out_ptr = &data_out[i * self_stride];
